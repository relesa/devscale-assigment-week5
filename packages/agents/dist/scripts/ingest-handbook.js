...
const handbookPath = new URL("../../../../documents/devscale-employee-handbook.md", import.meta.url);
...
console.log(`Inserted ${documents.length} sections into devscale_employee_handbook.`);
